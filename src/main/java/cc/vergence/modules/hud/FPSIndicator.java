...
public class FPSIndicator extends Module {
    public static FPSIndicator INSTANCE;
    private boolean lastMouseStatus = false;
    private double lastMouseX = -1;
    private double lastMouseY = -1;

    public FPSIndicator() {
        super("FPSIndicator", Category.HUD);
        INSTANCE = this;
        setX(0);
        setY(0);
        setWidth(0);
    ...
    public Option<String> text = addOption(new TextOption("Text", "{fps} FPS"));
