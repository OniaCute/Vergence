...
public final class TextureStorage {
    public static final Identifier star = Identifier.of("vergence", "textures/particles/star.png");
    public static final Identifier heart = Identifier.of("vergence", "textures/particles/heart.png");
