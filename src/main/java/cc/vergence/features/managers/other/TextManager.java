...
public class TextManager {
    ...
    private void loadEnglish() {
        ...
        englishLanguageBase.put("Theme.Messages.Loaded", "Theme \"{theme}\" ({raw_theme}) is loaded!");
        ...
        englishLanguageBase.put("Module.Modules.BetterChat.Options.ColorOption.PrefixColor.description", "Color of the chat prefix");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.TextOption.ChatPrefix.name", "Chat Prefix");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.TextOption.ChatPrefix.description", "Text placed before every chat message");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.TextOption.ChatSuffix.name", "Chat Suffix");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.TextOption.ChatSuffix.description", "Text placed after every chat message");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.BooleanOption.CustomNameColor.name", "Custom Name Color");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.BooleanOption.CustomNameColor.description", "Apply a custom color to your player name");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.ColorOption.PlayerNameColor.name", "Player Name Color");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.ColorOption.PlayerNameColor.description", "Color used for your player name when custom color is enabled");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.BooleanOption.CustomChatColor.name", "Custom Chat Color");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.BooleanOption.CustomChatColor.description", "Apply a custom color to your chat messages");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.ColorOption.PlayerChatColor.name", "Player Chat Color");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.ColorOption.PlayerChatColor.description", "Color used for your chat messages when custom color is enabled");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.DoubleOption.AnimationTime.name", "Animation Time");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.DoubleOption.AnimationTime.description", "Duration of the chat message fade in animation in milliseconds");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.DoubleOption.AnimationOffset.name", "Animation Offset");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.DoubleOption.AnimationOffset.description", "Horizontal offset applied to the fade in animation");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.EnumOption.AnimationQuadType.name", "Animation Type");
        englishLanguageBase.put("Module.Modules.BetterChat.Options.EnumOption.AnimationQuadType.description", "Easing type used for the chat fade in animation");
        ...
        englishLanguageBase.put("Module.Modules.AutoLogout.name", "Auto Logout");
        englishLanguageBase.put("Module.Modules.AutoLogout.description", "Automatically disconnects from the server when dangerous conditions are met");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.AutoDisable.name", "Auto Disable");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.AutoDisable.description", "Disable the module after a successful disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.AntiMistake.name", "Anti Mistake");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.AntiMistake.description", "Prevents instant disconnect after joining by waiting a short delay");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.RegretTime.name", "Regret Time");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.RegretTime.description", "Seconds to wait before allowing a disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.IllegalDisconnect.name", "Illegal Disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.IllegalDisconnect.description", "Send an invalid packet to force a disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Health.name", "Low Health");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Health.description", "Disconnect when health drops below threshold");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.LowestHealth.name", "Lowest Health");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.LowestHealth.description", "Health value that triggers a disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Players.name", "Player Count");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Players.description", "Disconnect when player count exceeds limit");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.MaxPlayers.name", "Max Players");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.MaxPlayers.description", "Maximum players allowed before disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Distance.name", "Enemy Distance");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.Distance.description", "Disconnect if an enemy is too close");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.MinDistance.name", "Min Distance");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.DoubleOption.MinDistance.description", "Minimum distance to trigger disconnect");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.IgnoreFriend.name", "Ignore Friend");
        englishLanguageBase.put("Module.Modules.AutoLogout.Options.BooleanOption.IgnoreFriend.description", "Exclude friends from player count and distance checks");
        englishLanguageBase.put("Module.Modules.AutoLogout.Messages.LowHealth", "§e[Auto Logout] §cYour health dropped below §b{health}§c!");
        englishLanguageBase.put("Module.Modules.AutoLogout.Messages.TooManyPlayers", "§e[Auto Logout] §cToo many players around you! §7(§b{amount}§7)");
        englishLanguageBase.put("Module.Modules.AutoLogout.Messages.TooCloseAround", "§e[Auto Logout] §cThere is a enemy within §b{distance} §cblocks!");

        englishLanguageBase.put("Module.Modules.AutoRepairArmor.name", "Auto Repair Armor");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.description", "Automatically throws XP bottles to repair your armor when durability is low");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Notify.name", "Notify");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Notify.description", "Notify you when repairing the item");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Sound.name", "Play Sound");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Sound.description", "Play a sound along with the notification");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.DurabilityCheck.name", "Durability Check");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.DurabilityCheck.description", "Stop repairing once all items are fully repaired");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Rotate.name", "Rotate");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Rotate.description", "Look straight up before throwing XP bottles");
        englishLanguageBase.put("Module.Modules.AutoRepairArmor.Options.BooleanOption.Swing.name", "Swing");
        ...
        englishLanguageBase.put("Module.Modules.ThemeEditor.name", "Theme Editor");
        englishLanguageBase.put("Module.Modules.ThemeEditor.description", "Edit and customize themes for Vergence client");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.DisplayName.name", "Display Name");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.DisplayName.description", "The display name of the theme");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.Description.name", "Description");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.Description.description", "A brief description of the theme");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.Author.name", "Author");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.TextOption.Author.description", "The author(s) of the theme (separated by ',')");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainColor.name", "Main Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainColor.description", "The primary color used in the theme");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainPageBackgroundColor.name", "Main Page Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainPageBackgroundColor.description", "Background color of the main page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainPageSplitLineColor.name", "Main Page Split Line Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.MainPageSplitLineColor.description", "Color of the split lines on the main page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryBackgroundColor.name", "Category Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryBackgroundColor.description", "Background color of categories");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryTextColor.name", "Category Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryTextColor.description", "Text color of categories");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryHoveredBackgroundColor.name", "Category Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryHoveredBackgroundColor.description", "Background color when a category is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryHoveredTextColor.name", "Category Hovered Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryHoveredTextColor.description", "Text color when a category is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryCurrentBackgroundColor.name", "Category Current Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryCurrentBackgroundColor.description", "Background color of the current category");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryCurrentTextColor.name", "Category Current Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.CategoryCurrentTextColor.description", "Text color of the current category");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleBackgroundColor.name", "Module Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleBackgroundColor.description", "Background color of modules");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledBackgroundColor.name", "Module Enabled Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledBackgroundColor.description", "Background color of enabled modules");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleTextColor.name", "Module Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleTextColor.description", "Text color of modules");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledTextColor.name", "Module Enabled Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledTextColor.description", "Text color of enabled modules");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredBackgroundColor.name", "Module Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredBackgroundColor.description", "Background color when a module is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredTextColor.name", "Module Hovered Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredTextColor.description", "Text color when a module is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleGearTextColor.name", "Module Gear Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleGearTextColor.description", "Text color of the gear icon in modules");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredGearTextColor.name", "Module Hovered Gear Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleHoveredGearTextColor.description", "Text color of the gear icon when hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledGearTextColor.name", "Module Enabled Gear Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ModuleEnabledGearTextColor.description", "Text color of the gear icon when enabled");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationBackgroundColor.name", "Notification Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationBackgroundColor.description", "Background color of notifications");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationTextColor.name", "Notification Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationTextColor.description", "Text color of notifications");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationHighlightTextColor.name", "Notification Highlight Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.NotificationHighlightTextColor.description", "Highlighted text color in notifications");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonCircleColor.name", "Button Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonCircleColor.description", "Color of the circular part of buttons");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonInlineColor.name", "Button Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonInlineColor.description", "Color of the inline part of buttons");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledCircleColor.name", "Button Enabled Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledCircleColor.description", "Color of the circular part when the button is enabled");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledInlineColor.name", "Button Enabled Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledInlineColor.description", "Color of the inline part when the button is enabled");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonBackgroundColor.name", "Button Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonBackgroundColor.description", "Background color of buttons");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredBackgroundColor.name", "Button Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredBackgroundColor.description", "Background color when a button is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledBackgroundColor.name", "Button Enabled Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonEnabledBackgroundColor.description", "Background color when a button is enabled");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredInlineColor.name", "Button Hovered Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredInlineColor.description", "Inline color when a button is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredCircleColor.name", "Button Hovered Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ButtonHoveredCircleColor.description", "Circular color when a button is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderBackgroundColor.name", "Slider Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderBackgroundColor.description", "Background color of sliders");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredBackgroundColor.name", "Slider Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredBackgroundColor.description", "Background color when a slider is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderCircleColor.name", "Slider Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderCircleColor.description", "Color of the circular part of sliders");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderInlineColor.name", "Slider Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderInlineColor.description", "Color of the inline part of sliders");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredCircleColor.name", "Slider Hovered Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredCircleColor.description", "Circular color when a slider is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredInlineColor.name", "Slider Hovered Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderHoveredInlineColor.description", "Inline color when a slider is hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderClickedCircleColor.name", "Slider Clicked Circle Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderClickedCircleColor.description", "Circular color when a slider is clicked");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderClickedInlineColor.name", "Slider Clicked Inline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderClickedInlineColor.description", "Inline color when a slider is clicked");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderValuedBackgroundColor.name", "Slider Valued Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.SliderValuedBackgroundColor.description", "Background color of the valued part of sliders");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.OptionsTextColor.name", "Options Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.OptionsTextColor.description", "Text color of options");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.OptionAreaBackgroundColor.name", "Option Area Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.OptionAreaBackgroundColor.description", "Background color of the option area");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HudEditorTipsTextColor.name", "HUD Editor Tips Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HudEditorTipsTextColor.description", "Text color of tips in the HUD editor");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HoverComponentBackgroundColor.name", "Hover Component Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HoverComponentBackgroundColor.description", "Background color of hover components");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HoverComponentTextColor.name", "Hover Component Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.HoverComponentTextColor.description", "Text color of hover components");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.DescriptionBackgroundColor.name", "Description Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.DescriptionBackgroundColor.description", "Background color of descriptions");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.DescriptionTextColor.name", "Description Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.DescriptionTextColor.description", "Text color of descriptions");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChatPrefixColor.name", "Chat Prefix Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChatPrefixColor.description", "Color of the chat prefix");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarBackgroundColor.name", "Top Bar Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarBackgroundColor.description", "Background color of the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarResearchFrameBackgroundColor.name", "Top Bar Research Frame Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarResearchFrameBackgroundColor.description", "Background color of the research frame in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarResearchFrameTextColor.name", "Top Bar Research Frame Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarResearchFrameTextColor.description", "Text color of the research frame in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarHoveredResearchFrameBackgroundColor.name", "Top Bar Hovered Research Frame Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarHoveredResearchFrameBackgroundColor.description", "Background color of the research frame when hovered in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarHoveredResearchFrameTextColor.name", "Top Bar Hovered Research Frame Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarHoveredResearchFrameTextColor.description", "Text color of the research frame when hovered in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarFocusedResearchFrameBackgroundColor.name", "Top Bar Focused Research Frame Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarFocusedResearchFrameBackgroundColor.description", "Background color of the research frame when focused in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarFocusedResearchFrameTextColor.name", "Top Bar Focused Research Frame Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopBarFocusedResearchFrameTextColor.description", "Text color of the research frame when focused in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarButtonBackgroundColor.name", "Topbar Button Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarButtonBackgroundColor.description", "Background color of buttons in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarHoveredButtonBackgroundColor.name", "Topbar Hovered Button Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarHoveredButtonBackgroundColor.description", "Background color of buttons when hovered in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarButtonIconColor.name", "Topbar Button Icon Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarButtonIconColor.description", "Icon color of buttons in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarHoveredButtonIconColor.name", "Topbar Hovered Button Icon Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.TopbarHoveredButtonIconColor.description", "Icon color of buttons when hovered in the top bar");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameBackgroundColor.name", "Input Frame Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameBackgroundColor.description", "Background color of input frames");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameTextColor.name", "Input Frame Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameTextColor.description", "Text color of input frames");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameHoveredBackgroundColor.name", "Input Frame Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameHoveredBackgroundColor.description", "Background color of input frames when hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameHoveredTextColor.name", "Input Frame Hovered Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.InputFrameHoveredTextColor.description", "Text color of input frames when hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesBackgroundColor.name", "Choices Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesBackgroundColor.description", "Background color of choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesTextColor.name", "Choices Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesTextColor.description", "Text color of choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesHoveredBackgroundColor.name", "Choices Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesHoveredBackgroundColor.description", "Background color of choices when hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesHoveredTextColor.name", "Choices Hovered Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesHoveredTextColor.description", "Text color of choices when hovered");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesDefaultBackgroundColor.name", "Choices Default Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesDefaultBackgroundColor.description", "Default background color of choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesDefaultTextColor.name", "Choices Default Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesDefaultTextColor.description", "Default text color of choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesEnabledBackgroundColor.name", "Choices Enabled Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesEnabledBackgroundColor.description", "Background color of enabled choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesEnabledTextColor.name", "Choices Enabled Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesEnabledTextColor.description", "Text color of enabled choices");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesAreaBackgroundColor.name", "Choices Area Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ChoicesAreaBackgroundColor.description", "Background color of the choices area");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ColorPaletteBackgroundColor.name", "Color Palette Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ColorPaletteBackgroundColor.description", "Background color of the color palette");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ColorPaletteOutlineColor.name", "Color Palette Outline Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ColorPaletteOutlineColor.description", "Outline color of the color palette");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenBackgroundColor.name", "Theme Page Component Chosen Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenBackgroundColor.description", "Background color of chosen components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentTextColor.name", "Theme Page Component Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentTextColor.description", "Text color of components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentAuthorsColor.name", "Theme Page Component Authors Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentAuthorsColor.description", "Color of authors in components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredAuthorsColor.name", "Theme Page Component Hovered Authors Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredAuthorsColor.description", "Color of authors when hovered in components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenAuthorsColor.name", "Theme Page Component Chosen Authors Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenAuthorsColor.description", "Color of authors in chosen components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredBackgroundColor.name", "Theme Page Component Hovered Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredBackgroundColor.description", "Background color of components when hovered on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentBackgroundColor.name", "Theme Page Component Background Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentBackgroundColor.description", "Background color of components on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredTextColor.name", "Theme Page Component Hovered Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentHoveredTextColor.description", "Text color of components when hovered on the theme page");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenTextColor.name", "Theme Page Component Chosen Text Color");
        englishLanguageBase.put("Module.Modules.ThemeEditor.Options.ColorOption.ThemePageComponentChosenTextColor.description", "Text color of chosen components on the theme page");
    }
    ...
    private void loadChinese() {
        ...
        chineseLanguageBase.put("COMMANDS.Prefix.desc", "设置指令前缀");
        chineseLanguageBase.put("COMMANDS.Toggle.desc", "切换模块状态");
        chineseLanguageBase.put("COMMANDS.CONFIG.desc", "管理配置文件");
        chineseLanguageBase.put("COMMANDS.MESSAGE.COMMAND_NOT_FOUND", "未找到相关指令:");
        chineseLanguageBase.put("COMMANDS.MESSAGE.INVALID_COMMAND", "§c无效的指令! §f输入§b help§f查看指令列表");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.LIST_TITLE", "§b好友:");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.EMPTY", "好友列表为空");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.RESET", "好友列表已重置");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.REMOVE", "好友删除成功");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.ADD", "好友添加成功");
        chineseLanguageBase.put("COMMANDS.MESSAGE.FRIEND.IS_ENEMY", "§c该玩家在你的敌人列表中!");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.LIST_TITLE", "§b敌人:");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.EMPTY", "敌人列表为空");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.RESET", "敌人列表已重置");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.REMOVE", "敌人删除成功");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.ADD", "敌人添加成功");
        chineseLanguageBase.put("COMMANDS.MESSAGE.ENEMY.IS_FRIEND", "§c该玩家在你的好友列表中!");
        chineseLanguageBase.put("COMMANDS.MESSAGE.BIND.UNKNOWN_MODULE", "目标是一个未知模块");
        chineseLanguageBase.put("COMMANDS.MESSAGE.BIND.NO_KEY", "请指定一个按键");
        chineseLanguageBase.put("COMMANDS.MESSAGE.BIND.UNKNOWN_ERROR", "未知内部错误");
        chineseLanguageBase.put("COMMANDS.MESSAGE.BIND.BIND_OK", "按键绑定成功");
        chineseLanguageBase.put("COMMANDS.MESSAGE.PREFIX.NO_PREFIX", "请指定一个前缀。（一个字符）");
        chineseLanguageBase.put("COMMANDS.MESSAGE.PREFIX.OK", "当前前缀是");
        chineseLanguageBase.put("COMMANDS.MESSAGE.TOGGLE.UNKNOWN_MODULE", "目标是一个未知模块");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.SAVED", "配置 \"{config}\" 已保存");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.LOADED", "配置 \"{config}\" 已加载");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.LIST_TITLE", "配置:");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.NO_CONFIGS", "§c未找到配置文件");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.NOT_FOUND", "配置 §b{config} §r未找到");
        chineseLanguageBase.put("COMMANDS.CONFIG.MESSAGE.MISSING_NAME", "§c请指定一个配置名称");
        chineseLanguageBase.put("COMMANDS.THEME.desc", "管理自定义主题");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.SAVED", "主题 \"{theme}\" 已保存");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.LOADED", "主题 \"{theme}\" 已加载");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.LIST_TITLE", "主题:");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.NO_THEMES", "§c未找到主题!");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.NOT_FOUND", "主题 §b{theme} §r未找到");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.MISSING_NAME", "§c请指定一个主题名称");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.DELETED", "主题 \"{theme}\" 已删除");
        chineseLanguageBase.put("COMMANDS.THEME.MESSAGE.CANNOT_DELETE_DEFAULT", "§c无法删除默认主题");

        chineseLanguageBase.put("SCREEN.MainMenu.Buttons.SinglePlayer", "单人游戏");
        chineseLanguageBase.put("SCREEN.MainMenu.Buttons.MultiPlayer", "多人游戏");
        chineseLanguageBase.put("SCREEN.MainMenu.Buttons.Options", "选项");
        chineseLanguageBase.put("SCREEN.MainMenu.Buttons.Exit", "退出");
        ...
        chineseLanguageBase.put("Module.Special.Options.MultipleOptions.Empty", "空");
        chineseLanguageBase.put("Module.Special.Messages.Blocked", "模块 §b{a} §r被 §b{b}§r 阻止");
        chineseLanguageBase.put("Module.Special.Messages.Unblock", "模块 §b{a} §r被 §b{b}§r 解除阻止");
        chineseLanguageBase.put("Module.Special.Messages.Enable", "模块 {module} 已§a启用");
        chineseLanguageBase.put("Module.Special.Messages.Disable", "模块 {module} 已§c禁用");
        ...
        chineseLanguageBase.put("Module.Special.ModulePriority.name", "优先级");
        chineseLanguageBase.put("Module.Special.ModulePriority.description", "模块的优先级");
        chineseLanguageBase.put("Module.Special.ModuleDraw.name", "显示");
        chineseLanguageBase.put("Module.Special.ModuleDraw.description", "在 ArrayList 中显示模块");

        chineseLanguageBase.put("Theme.DefaultTheme.name", "默认主题");
        chineseLanguageBase.put("Theme.DefaultTheme.description", "vergence 客户端的默认主题");
        chineseLanguageBase.put("Theme.Messages.Loaded", "主题 \"{theme}\" ({raw_theme}) 已加载!");
