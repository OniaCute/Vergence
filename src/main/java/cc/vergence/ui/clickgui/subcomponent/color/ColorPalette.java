...
public class ColorPalette extends GuiComponent {
    ...
    public void onDraw(double mouseX, double mouseY, boolean clickLeft, boolean clickRight) {
        boolean click_left;
        if (mouseY < GuiManager.MAIN_PAGE_Y || mouseY > GuiManager.MAIN_PAGE_Y + GuiManager.MAIN_PAGE_HEIGHT) {
            click_left = false;
        } else {
...
//        };
//
//        Render2DUtil.insertDisplayArea( // calc padding
//                (float) (x - 2),
//                (float) (GuiManager.MAIN_PAGE_Y),
//                (float) (x + width + 2),
