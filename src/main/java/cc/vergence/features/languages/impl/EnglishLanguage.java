...
public class EnglishLanguage extends Language {
    ...
    public void load() {
        ...
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Speed.name", "{speed}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Speed.description", "Player speed placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Speeds_Km.name", "{speed_km}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Speeds_Km.description", "Player speed in kilometers per hour placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Fps.name", "{fps}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Fps.description", "Current FPS placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Memory.name", "{memory}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Memory.description", "Current memory usage placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Memory_Max.name", "{memory_max}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Memory_Max.description", "Maximum memory usage placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Ping.name", "{ping}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Ping.description", "Current ping placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Combo.name", "{combo}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Combo.description", "Current combo count placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_X.name", "{x}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_X.description", "Player X position placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_Y.name", "{y}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_Y.description", "Player Y position placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_Z.name", "{z}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Position_Z.description", "Player Z position placeholder");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_CPS.name", "{cps}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_CPS.description", "Player CPS");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Right_CPS.name", "{right_cps}");
        languageBase.put("Module.Modules.Placeholder.Options.TextOption.Placeholder_Right_CPS.description", "Player right CPS");
        ...
        languageBase.put("Module.Modules.Hotkeys.name", "Hotkeys Hud");
        languageBase.put("Module.Modules.Hotkeys.description", "Displays keybinds for enabled modules on the HUD");
        languageBase.put("Module.Modules.Hotkeys.Options.EnumOption.Mode.name", "Mode");
        languageBase.put("Module.Modules.Hotkeys.Options.EnumOption.Mode.description", "Size mode of Hotkeys HUD.");
        languageBase.put("Module.Modules.Hotkeys.Options.TextOption.Title.name", "Title");
        languageBase.put("Module.Modules.Hotkeys.Options.TextOption.Title.description", "Title text for the hotkeys display");
        languageBase.put("Module.Modules.Hotkeys.Options.EnumOption.TitleAlign.name", "Title Align");
        languageBase.put("Module.Modules.Hotkeys.Options.EnumOption.TitleAlign.description", "Alignment of the title text");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.TitleColor.name", "Title Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.TitleColor.description", "Color of the title text");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.ModuleColor.name", "Module Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.ModuleColor.description", "Color of the module names");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.KeybindColor.name", "Keybind Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.KeybindColor.description", "Color of the keybind text");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.ModuleEnabledColor.name", "Module Enabled Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.ModuleEnabledColor.description", "Color of enabled module names");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.KeybindEnabledColor.name", "Keybind Enabled Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.KeybindEnabledColor.description", "Color of enabled keybind text");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.SplitLineColor.name", "Split Line Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.SplitLineColor.description", "Color of the line separating title and hotkeys");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.EnabledOnly.name", "Enabled Only");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.EnabledOnly.description", "Show only enabled modules");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Background.description", "Enable background behind hotkeys");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.BackgroundColor.name", "Background Color");
        languageBase.put("Module.Modules.Hotkeys.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.Hotkeys.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.Hotkeys.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.Hotkeys.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.Hotkeys.Options.DoubleOption.TitleOffset.name", "Title Offset");
        languageBase.put("Module.Modules.Hotkeys.Options.DoubleOption.TitleOffset.description", "Vertical offset of the title text");
        ...
        languageBase.put("Module.Modules.StorageESP.description", "Highlights storage blocks in the world");
        languageBase.put("Module.Modules.StorageESP.Options.DoubleOption.Range.name", "Range");
        languageBase.put("Module.Modules.StorageESP.Options.DoubleOption.Range.description", "Search radius around the player");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ChestFillColor.name", "Chest Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ChestFillColor.description", "Fill color for chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.TrappedChestFillColor.name", "Trapped Chest Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.TrappedChestFillColor.description", "Fill color for trapped chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.EnderChestFillColor.name", "Ender Chest Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.EnderChestFillColor.description", "Fill color for ender chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BarrelFillColor.name", "Barrel Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BarrelFillColor.description", "Fill color for barrels");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ShulkerBoxFillColor.name", "Shulker Box Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ShulkerBoxFillColor.description", "Fill color for shulker boxes");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.FurnaceFillColor.name", "Furnace Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.FurnaceFillColor.description", "Fill color for furnaces");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BlastFurnaceFillColor.name", "Blast Furnace Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BlastFurnaceFillColor.description", "Fill color for blast furnaces");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.SmokerFillColor.name", "Smoker Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.SmokerFillColor.description", "Fill color for smokers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DispenserFillColor.name", "Dispenser Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DispenserFillColor.description", "Fill color for dispensers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DropperFillColor.name", "Dropper Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DropperFillColor.description", "Fill color for droppers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.HopperFillColor.name", "Hopper Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.HopperFillColor.description", "Fill color for hoppers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.CraftingTableFillColor.name", "Crafting Table Fill Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.CraftingTableFillColor.description", "Fill color for crafting tables");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ChestOutlineColor.name", "Chest Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ChestOutlineColor.description", "Outline color for chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.TrappedChestOutlineColor.name", "Trapped Chest Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.TrappedChestOutlineColor.description", "Outline color for trapped chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.EnderChestOutlineColor.name", "Ender Chest Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.EnderChestOutlineColor.description", "Outline color for ender chests");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BarrelOutlineColor.name", "Barrel Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BarrelOutlineColor.description", "Outline color for barrels");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ShulkerBoxOutlineColor.name", "Shulker BoxOutline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.ShulkerBoxOutlineColor.description", "Outline color for shulker boxes");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.FurnaceOutlineColor.name", "Furnace Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.FurnaceOutlineColor.description", "Outline color for furnaces");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BlastFurnaceOutlineColor.name", "Blast Furnace Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.BlastFurnaceOutlineColor.description", "Outline color for blast furnaces");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.SmokerOutlineColor.name", "Smoker Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.SmokerOutlineColor.description", "Outline color for smokers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DispenserOutlineColor.name", "Dispenser Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DispenserOutlineColor.description", "Outline color for dispensers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DropperOutlineColor.name", "Dropper Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.DropperOutlineColor.description", "Outline color for droppers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.HopperOutlineColor.name", "Hopper Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.HopperOutlineColor.description", "Outline color for hoppers");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.CraftingTableOutlineColor.name", "Crafting Table Outline Color");
        languageBase.put("Module.Modules.StorageESP.Options.ColorOption.CraftingTableOutlineColor.description", "Outline color for crafting tables");
        languageBase.put("Module.Modules.StorageESP.Options.MultipleOption.Mode.name", "Mode");
        languageBase.put("Module.Modules.StorageESP.Options.MultipleOption.Mode.description", "Rendering modes to apply");
        ...
        languageBase.put("Module.Modules.MurdererCatcher.description", "Detects and highlights murderers and bowmen in mini game modes");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkMurderer.name", "Mark Murderer");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkMurderer.description", "Enable highlighting of murderers");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkBowmer.name", "Mark Bowmer");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkBowmer.description", "Enable highlighting of bowmen");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkShine.name", "Shine");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.MarkShine.description", "Apply shine effect to highlighted players");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.BowmenFillColor.name", "Bowmen Fill Color");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.BowmenFillColor.description", "Fill color for bowmen");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.BowmenOutlineColor.name", "Bowmen Outline Color");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.BowmenOutlineColor.description", "Outline color for bowmen");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.MurdererFillColor.name", "Murderer Fill Color");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.MurdererFillColor.description", "Fill color for murderers");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.MurdererOutlineColor.name", "Murderer Outline Color");
        languageBase.put("Module.Modules.MurdererCatcher.Options.ColorOption.MurdererOutlineColor.description", "Outline color for murderers");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.Sound.name", "Sound");
        languageBase.put("Module.Modules.MurdererCatcher.Options.BooleanOption.Sound.description", "Play sound notifications when detecting roles");
        ...
        languageBase.put("Module.Modules.ChatFilter.name", "Chat Filter");
        languageBase.put("Module.Modules.ChatFilter.description", "Filters chat messages based on keywords");
        languageBase.put("Module.Modules.ChatFilter.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.ChatFilter.Options.TextOption.Text.description", "Keywords to hide");
        languageBase.put("Module.Modules.ChatFilter.Options.TextOption.Unless.name", "Unless");
        languageBase.put("Module.Modules.ChatFilter.Options.TextOption.Unless.description", "Keywords that override hiding");

        languageBase.put("Module.Modules.FastParty.name", "Fast Party");
        languageBase.put("Module.Modules.FastParty.description", "Instantly party nearby unlisted players");
        languageBase.put("Module.Modules.FastParty.Options.DoubleOption.Range.name", "Range");
        languageBase.put("Module.Modules.FastParty.Options.DoubleOption.Range.description", "Radius in blocks to search for players");

        languageBase.put("Module.Modules.SpeedIndicator.name", "Speed Indicator");
        languageBase.put("Module.Modules.SpeedIndicator.description", "Displays the player's current speed on the HUD");
        languageBase.put("Module.Modules.SpeedIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.SpeedIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.SpeedIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.SpeedIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.SpeedIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.FPSIndicator.name", "FPS Indicator");
        languageBase.put("Module.Modules.FPSIndicator.description", "Displays the client's fps on the HUD");
        languageBase.put("Module.Modules.FPSIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.FPSIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.FPSIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.FPSIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.FPSIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.FPSIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.FPSIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.MemoryIndicator.name", "Memory Indicator");
        languageBase.put("Module.Modules.MemoryIndicator.description", "Displays the client's memory and limit on the HUD");
        languageBase.put("Module.Modules.MemoryIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.MemoryIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.MemoryIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.MemoryIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.MemoryIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.PingIndicator.name", "Latency Indicator");
        languageBase.put("Module.Modules.PingIndicator.description", "Display the latency between the client and the server on the HUD");
        languageBase.put("Module.Modules.PingIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.PingIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.PingIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.PingIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.PingIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.PingIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.PingIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.ComboIndicator.name", "Combo Indicator");
        languageBase.put("Module.Modules.ComboIndicator.description", "Display the player's combo on the HUD");
        languageBase.put("Module.Modules.ComboIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.ComboIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.ComboIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.ComboIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.ComboIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.ComboIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.ComboIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.PositionIndicator.name", "Position Indicator");
        languageBase.put("Module.Modules.PositionIndicator.description", "Display the player's position on the HUD");
        languageBase.put("Module.Modules.PositionIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.PositionIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.PositionIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.PositionIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.PositionIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.PositionIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.PositionIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.CPSIndicator.name", "CPS Indicator");
        languageBase.put("Module.Modules.CPSIndicator.description", "Display the player's CPS on the HUD");
        languageBase.put("Module.Modules.CPSIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.CPSIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.CPSIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.CPSIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.CPSIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.CPSIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.CPSIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.GameTimeIndicator.name", "Game Time Indicator");
        languageBase.put("Module.Modules.GameTimeIndicator.description", "Display the time how long you were playing on the HUD");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.GameTimeIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.ServerIndicator.name", "Server Indicator");
        languageBase.put("Module.Modules.ServerIndicator.description", "Display the server's ip on the HUD");
        languageBase.put("Module.Modules.ServerIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.ServerIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.ServerIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.ServerIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.ServerIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.ServerIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.ServerIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.DistanceIndicator.name", "Distance Indicator");
        languageBase.put("Module.Modules.DistanceIndicator.description", "Display the distance between the player and the target on the HUD");
        languageBase.put("Module.Modules.DistanceIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.DistanceIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.DistanceIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.DistanceIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.DistanceIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.TickShiftIndicator.name", "Tick Shift Indicator");
        languageBase.put("Module.Modules.TickShiftIndicator.description", "Display the tick shift module details on the HUD");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.EnumOption.FontSize.description", "Size of the displayed text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.TextOption.Text.name", "Text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.TextOption.Text.description", "Custom text format for the speed display");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.TextColor.description", "Color of the text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Icon.name", "Icon");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Icon.description", "Show an icon next to the speed text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.IconColor.name", "Icon Color");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.IconColor.description", "Color of the icon");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Background.description", "Enable background behind the text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Outline.name", "Outline");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.BooleanOption.Outline.description", "Draw an outline around the background");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.OutlineWidth.name", "Outline Width");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.OutlineWidth.description", "Width of the outline");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.OutlineColor.name", "Outline Color");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.ColorOption.OutlineColor.description", "Color of the outline");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.Offset.description", "The y axis offset of text");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.IconOffset.name", "Icon Offset");
        languageBase.put("Module.Modules.TickShiftIndicator.Options.DoubleOption.IconOffset.description", "The y axis offset of icon");

        languageBase.put("Module.Modules.KeyStrokes.name", "Key Strokes");
        languageBase.put("Module.Modules.KeyStrokes.description", "Displays pressed movement keys on the HUD");
        languageBase.put("Module.Modules.KeyStrokes.Options.EnumOption.FontSize.name", "Font Size");
        languageBase.put("Module.Modules.KeyStrokes.Options.EnumOption.FontSize.description", "Size of the text");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.TextColor.name", "Text Color");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.TextColor.description", "Color of the text when not pressed");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.TextEnabledColor.name", "Text Enabled Color");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.TextEnabledColor.description", "Color of the text when pressed");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Offset.name", "Offset");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Offset.description", "Vertical offset of the text");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Margin.name", "Margin");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Margin.description", "Spacing between keys");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Padding.name", "Padding");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Padding.description", "Padding around each key");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.WithSpace.name", "Space");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.WithSpace.description", "Include space key in display");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.SpaceMargin.name", "Space Margin");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.SpaceMargin.description", "Spacing for the space key");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Background.description", "Enable background behind keys");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.BackgroundColor.name", "Background Color");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.BackgroundColor.description", "Color of the background when not pressed");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.BackgroundEnabledColor.name", "Background Enabled Color");
        languageBase.put("Module.Modules.KeyStrokes.Options.ColorOption.BackgroundEnabledColor.description", "Color of the background when pressed");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.KeyStrokes.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.Radius.description", "Radius of the rounded corners");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.SpaceRadius.name", "Space Radius");
        languageBase.put("Module.Modules.KeyStrokes.Options.DoubleOption.SpaceRadius.description", "Radius of the rounded corners for the space key");

        languageBase.put("Module.Modules.ArmorHud.name", "Armor Hud");
        languageBase.put("Module.Modules.ArmorHud.description", "Displays the player's armor items on the HUD");
        languageBase.put("Module.Modules.ArmorHud.Options.EnumOption.Mode.name", "Mode");
        languageBase.put("Module.Modules.ArmorHud.Options.EnumOption.Mode.description", "Layout mode for displaying armor items");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Scale.name", "Scale");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Scale.description", "Scale of the armor icons");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Padding.name", "Padding");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Padding.description", "Spacing between armor icons");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.OffsetX.name", "OffsetX");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.OffsetX.description", "Horizontal offset of the armor icons");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.OffsetY.name", "OffsetY");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.OffsetY.description", "Vertical offset of the armor icons");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Durability.name", "Durability");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Durability.description", "Show durability bar on armor items");
        languageBase.put("Module.Modules.ArmorHud.Options.ColorOption.DurabilityColor.name", "Durability Color");
        languageBase.put("Module.Modules.ArmorHud.Options.ColorOption.DurabilityColor.description", "Color of the durability bar");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Background.description", "Enable background behind armor icons");
        languageBase.put("Module.Modules.ArmorHud.Options.ColorOption.BackgroundColor.name", "BackgroundColor");
        languageBase.put("Module.Modules.ArmorHud.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Rounded.name", "Rounded");
        languageBase.put("Module.Modules.ArmorHud.Options.BooleanOption.Rounded.description", "Use rounded corners for the background");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Radius.name", "Radius");
        languageBase.put("Module.Modules.ArmorHud.Options.DoubleOption.Radius.description", "Radius of the rounded corners");

        languageBase.put("Module.Modules.TargetHud.name", "Target Hud");
        languageBase.put("Module.Modules.TargetHud.description", "Displays information about the targeted player");
        languageBase.put("Module.Modules.TargetHud.Options.DoubleOption.LifeTime.name", "Life Time");
        languageBase.put("Module.Modules.TargetHud.Options.DoubleOption.LifeTime.description", "Duration the target information is displayed in milliseconds");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.NickPlayer.name", "Nick Player");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.NickPlayer.description", "Display a custom nickname instead of the player's actual name");
        languageBase.put("Module.Modules.TargetHud.Options.TextOption.NickName.name", "Nick Name");
        languageBase.put("Module.Modules.TargetHud.Options.TextOption.NickName.description", "Custom nickname to display");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.PlayerNameColor.name", "Player Name Color");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.PlayerNameColor.description", "Color of the player's name");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.PlayerHealthColor.name", "Player Health Color");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.PlayerHealthColor.description", "Color of the health bar");
        languageBase.put("Module.Modules.TargetHud.Options.DoubleOption.HealthRadius.name", "Health Radius");
        languageBase.put("Module.Modules.TargetHud.Options.DoubleOption.HealthRadius.description", "Radius of the rounded corners for the health bar");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Items.name", "Items");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Items.description", "Display the targeted player's armor items");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Background.name", "Background");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Background.description", "Enable background behind the HUD");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.BackgroundColor.name", "Background Color");
        languageBase.put("Module.Modules.TargetHud.Options.ColorOption.BackgroundColor.description", "Color of the background");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Blur.name", "Blur");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Blur.description", "Apply blur effect to the background");
        languageBase.put("Module.Modules.TargetHud.Options.BooleanOption.Rounded.name", "Rounded");
