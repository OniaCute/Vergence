...
public class NewFontUtil implements Wrapper {
    ...
    public static void drawText(String text, double x, double y, Color color, FontSize size, boolean shadow) {
        ...
        if (shadow) {
            ...
            NewRender2DUtil.getCanvas().drawString(text, drawX + shadowOffset, drawY + shadowOffset, font, NewRender2DUtil.getPaint(new Color(7, 7, 7)));
        }
        NewRender2DUtil.getCanvas().drawString(text, drawX, drawY, font, NewRender2DUtil.getPaint(color));
    }
    ...
    public static void drawTextWithAlign(String text, double x, double y, double ex, double ey, Color color, FontSize size, Aligns align, boolean shadow) {
        ...
        Pair<Double, Double> pos = NewRender2DUtil.getAlignPositionAsPair(x, y, ex, ey, w, h, align);
        drawText(text, pos.getA(), pos.getB(), color, size, shadow);
    }
