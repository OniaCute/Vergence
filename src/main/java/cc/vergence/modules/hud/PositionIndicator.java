...
public class PositionIndicator extends Module {
    public static PositionIndicator INSTANCE;
    private boolean lastMouseStatus = false;
    private double lastMouseX = -1;
    private double lastMouseY = -1;

    public PositionIndicator() {
        super("PositionIndicator", Category.HUD);
        INSTANCE = this;
        setX(0);
        setY(0);
        setWidth(0);
    ...
    public Option<String> text = addOption(new TextOption("Text", "X {x} Y{y} Z{z} [{world}]"));
