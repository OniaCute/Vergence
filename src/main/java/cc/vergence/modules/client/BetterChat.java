...
public class BetterChat extends Module {
    ...
    public Option<String> playerNamePrefix = addOption(new TextOption("PlayerNamePrefix", "<", v -> customNameColor.getValue()));
    public Option<String> playerNameSuffix = addOption(new TextOption("PlayerNameSuffix", ">", v -> customNameColor.getValue()));
    ...
    public Option<String> playerChatPrefix = addOption(new TextOption("PlayerChatPrefix", " ", v -> customChatColor.getValue()));
